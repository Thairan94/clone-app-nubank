...
export const UperView = styled.View`
    flex-direction: row;
    align-items: center;
...
export const TextWellcome = styled.Text`
    color: #fff;
    font-size: 16px;
    font-weight: bold;
`
...
export const Subtitle = styled.Text`
    ...
    margin-bottom: 8px;
`
export const BalenceTotal = styled.Text`
  font-size: 20px;
  font-weight: 700;
  margin-top: 8px;
`

export const BalenceTotalNotVisible = styled.View`
    margin-top: 8px;
    height: 30px;
    width: 70%;
